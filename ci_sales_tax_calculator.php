...
Version: 1.0.0
Author: Sales Tax Calculator / www.calculator.io
...
if (!function_exists('add_shortcode')) return "No direct call for Sales Tax Calculator by www.calculator.io";

function display_calcio_ci_sales_tax_calculator(){
    $page = 'index.html';
...
add_shortcode( 'ci_sales_tax_calculator', 'display_calcio_ci_sales_tax_calculator' );